// Autogenerated by Thrift Compiler (2.0.0-upfluence)
...
func NewBaseServiceClientFactoryProvider(p thrift.TClientProvider) (*BaseServiceClient, error) {
	...
	return &BaseServiceClient{TClient: cl}, nil
}
...
func NewBaseServiceProcessor(handler BaseService, middlewares []thrift.TMiddleware) *thrift.TStandardProcessor {
