...
func (p *SemanticVersion) StructDefinition() thrift.StructDefinition {
	return thrift.StructDefinition{Namespace: "", Name: "SemanticVersion"}
}
...
func (p *GitVersion) StructDefinition() thrift.StructDefinition {
	return thrift.StructDefinition{Namespace: "", Name: "GitVersion"}
}
...
func (p *Version) StructDefinition() thrift.StructDefinition {
	return thrift.StructDefinition{Namespace: "", Name: "Version"}
}
